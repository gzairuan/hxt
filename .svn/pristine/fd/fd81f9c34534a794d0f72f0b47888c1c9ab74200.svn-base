...
<body class="gray-bg">
	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<!-- 表格上班按钮（新增等）的工具条 -->
				<div id="toolbar">
					<button class="btn btn-sm btn-primary add-role" data-toggle="modal" data-flag="add"
						data-title="添加学生"
						data-target="#stuModal">
						<span class="glyphicon glyphicon-plus" aria-hidden="true"></span>新增
					</button>
					<button class="btn btn-sm btn-primary add-role" onclick="batchRemoveBtn()">
						<i class="fa fa-mail-forward"> 批量调动</i>
					</button>
					<button class="btn btn-sm btn-primary add-role" onclick="classRemoveBtn()">
						<i class="fa fa-mail-forward"> 班级调动</i>
					</button>
					<button class="btn btn-sm btn-danger delete-role" style="display: none;"  data-toggle="modal"
				...
				<div class="modal-body">
					...
					<div class="box-body no-padding">
						<form id="stuForm" role="form" class="form-horizontal">
								<div class="col-md-6">
									<div class="form-group">
										<label for="stuClassSelect" class="col-md-4 control-label">班级：</label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label for="stuBirthday" class="col-md-4 control-label">生日：</label>
										<div class="col-md-6">
											<input name="stuBidthday" type="text" id="stuBirthday" class="form-control" readonly/>
										</div>
									</div>
									<div class="form-group">
										<label for="stuEntrySchoolDate" class="col-md-4 control-label">入校日期：</label>
										<div class="col-md-6">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label for="stuSex" class="col-md-4 control-label">性别：</label>
										<div class="col-md-6">
									...
									<div class="form-group">
										<label for="stuNo" class="col-md-4 control-label">学号：</label>
										<div class="col-md-6">
								...
								<div class="col-md-12">
									<div class="form-group">
										<label for="stuAddress" class="col-md-2 control-label">地址：</label>
										<div class="col-md-9">
											<input name="stuAddress" type="text" id="stuAddress" class="form-control" />
										</div>
									</div>
									<div class="form-group" id="detailPL" style="display: none;">
										<label class="col-md-2 control-label">联系家长：</label>
										<div class="col-md-9">
											<textarea rows="5" id="parentlink" class="form-control" readonly="readonly">
											</textarea>
										</div>
									</div>
								</div>
	...
	<!-- table 班级学生调动modal -->
	<div id="transferModal" class="modal fade" role='dialog' tabindex="-1" aria-labelledby="delModalLabel" data-backdrop="true" aria-hidden="true">
		<div class="modal-dialog " role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h5 class="modal-title" id="delModalLabel">学生信息调动</h5>
				</div>
				<div class="modal-body">
					<form id="transferForm" class="form-horizontal bv-form">
						<div class="form-group" id="preTransferId">
							<label class="control-label col-sm-3">调动前班级</label>
							<div class="col-md-5">
								<select id="preTransClassSelcet" class="form-control">
									<option value="">班级</option>
								</select>
							</div>
						</div>
						<div class="form-group" id="nexTransferId">
							<label class="control-label col-sm-3">调动后班级</label>
							<div class="col-md-5">
								<select id="nexTransClassSelcet" class="form-control">
									<option value="">班级</option>
								</select>
							</div>
						</div>
				...
				<div class="modal-footer">
					<!--  <span id='deleteButton'></span> -->
					<button id="btnTtrans" type="button" class="btn btn-delete" data-dismiss="modal">确定</button>
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
				</div>
	...
	<script type="text/javascript" src="student.js?v=1.2"></script>
