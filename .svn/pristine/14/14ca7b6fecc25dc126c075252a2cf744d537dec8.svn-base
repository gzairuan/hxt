				...
				var domli = 
					'<li id="ablumLiId">'+
						'<div class="post-container">'+
							'<div class="post-option operate-role" style="display:none;">' +
								'<ul class="list-options">'+ //操作 
									'<li class="edit-role" style="display:none;">' +
									...
									'</li>'+
									'<li class="delete-role" style="display:none;">' +
					...
					'<li id="photoLiId">'+
						'<div class="post-container">'+
							'<div class="post-option">' +
								'<ul class="list-options operate-role" style="display:none;">'+ //操作 
									'<li class="edit-role" style="display:none;">' +
