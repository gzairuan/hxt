...
<body class="gray-bg">
		...
		<div class="modal-dialog" role="document">
			...
			<div class="modal-content">
				...
				<div class="modal-header">
					...
					<!-- 右上角关闭按钮“x” -->
					<h5 class="modal-title" id="addModalTitle">新增班级通知</h5>
				</div>
						...
						<form id="addForm" class="form-horizontal" role="form">
							<div class="col-md-12">
								<div class="form-group">
									...
									<select id="addClassID" class="form-control" name="cid">
									</select>
								</div>
								<div class="form-group">
				...
				<div class="modal-footer">
					<button id="addBtnSave" type="button" class="btn btn-primary">发布</button>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="control-label">接收班级</label> <input
							class="form-control receive-class" readonly>
					</div>
					<div class="form-group">
	...
	<script type="text/javascript" src="classnotice.js"></script>
