...
<body class="gray-bg">
					...
					<div class="form-horizontal" role="form" >
						...
						<div class="col-md-4">
							<div class="form-group">
								...
								<div class="col-md-7">
									<select id="queClassID" class="form-control" onchange="changeClass()">
										<option value="0">全部</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-4 control-label" for="queClassID">学生：</label>
								<div class="col-md-7">
									<select id="queStudentID" class="form-control">
										<option value="0">全部</option>
									</select>
								</div>
							</div>
	...
	<!-- 界面js -->
	<script src="attendance.js?v=1.0"></script>
