...
<body class="gray-bg">
	...
	<div class="wrapper wrapper-content animated fadeInRight">
		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				...
				<div id="toolbar">
					<button class="btn btn-sm btn-primary add-role" style="display: none;" data-toggle="modal"
					...
					<div class="box-body no-padding">
						<form id="addForm" class="form-horizontal" role="form">
							<div class="col-md-12">
								...
								<div class="form-group">
									<label class="col-md-4 control-label" for="addBreakfast">早餐：</label>
									<div class="col-md-6">
										<input type="text" id="addBreakfast" name="breakfast"
											class="form-control" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-4 control-label" for="addLunch">午餐：</label>
									<div class="col-md-6">
										<input type="text" id="addLunch" name="lunch"
											class="form-control" />
									</div>
								</div>
							</div>
	...
	<div class="modal fade" id="detailModal" tabindex="-1" role="dialog"
		aria-lablledby="detailModalTitle" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<!-- 会话窗口 -->
			<div class="modal-content">
				<!-- 模态框内容 -->
				<div class="modal-header">
					...
					<button type="button" class="close" data-dismiss="modal"
						aria-hidden="true">&times;</button>
					<!-- 右上角关闭按钮“x” -->
					<h5 class="modal-title" id="detailModalTitle">食谱详情</h5>
				</div>
				<div class="modal-body">
					<!-- 模态框主题内容布局 -->
					<div class="box-body no-padding">
						<div class="form-horizontal" role="form">
							<div class="col-md-12">
								<div class="form-group">
									<label class="col-md-4 control-label" for="detailDate">日期：</label>
									<div class="col-md-6">
										<input type="text" id="detailDate" name="date" class="form-control" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-4 control-label" for="detailWeekday">星期：</label>
									<div class="col-md-6">
										<input type="text" id="detailWeekday" name="date" class="form-control" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-4 control-label" for="detailBreakfast">早餐：</label>
									<div class="col-md-6">
										<input type="text" id="detailBreakfast" name="breakfast"
											class="form-control" readonly="readonly"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-4 control-label" for="detailLunch">午餐：</label>
									<div class="col-md-6">
										<input type="text" id="detailLunch" name="lunch"
											class="form-control" readonly="readonly"/>
									</div>
								</div>
							</div>
	...
	<script src="cookbook.js?v=1.0"></script>
