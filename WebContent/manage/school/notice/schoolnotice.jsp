    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
            	...
            	<div id="toolbar">
					<button id="btn-add" type="button" class="btn btn-sm btn-primary add-role" data-toggle="modal" data-target="#addModal"  style="display: none;">
                ...
                <div class="modal-body">
					...
					<form id="addForm">
						...
						<div class="form-group" id="selectImgDiv" style="display: none">
							<input id="addImgs" class="file" type="file" data-preview-file-type="text" multiple>
						</div>
					</form>
				</div>
